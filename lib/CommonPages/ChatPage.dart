...
class ChatScreenState extends State<ChatScreen> {
  ...
  void onSendMessage(String content, int type) {
    ...
    if (content.trim() != '') {
      ...
      // On crée une collection messages. Ensuite un crée un groupID (un id propre à la discussion de deux users.)
      // On crée un document avec groupId, puis dans ce document on crée une collection qui a le nom du document, et qui
      // Contiendra l'ensemble des messages.
      ...
      child: groupChatId == null
          ...
          : StreamBuilder(
              ...
              builder: (context, snapshot) {
                if (!snapshot.hasData) {
                  return Center(child: MiamityProgressIndicator());
                } else {
